    ...
    return (
      <div className='w-full h-[100vh] bg-gradient-to-t from-black to-[#02023d] flex justify-center items-center flex-col gap-[15px] overflow-hidden'>
        ...
        <div className={`absolute lg:hidden top-0 w-full h-full bg-[#00000053] backdrop-blur-lg p-[20px] flex flex-col gap-[20px] items-start ${ham ? "translate-x-0":"translate-x-full"} transition-transform`}>  
          ...
          <button
          onClick={handleLogOut}className='min-w-[150px] h-[60px] mt-[10px] text-black font-semibold  bg-white rounded-full text-[19px]'
        >
          Log Out
        </button>

        <button
          className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px] px-[20px] py-[10px] cursor-pointer'
        ...
        <button
          onClick={handleLogOut}className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold absolute hidden lg:block top-[20px] right-[20px] bg-white rounded-full text-[19px]'
        >
          Log Out
        </button>
        ...
        <h1 className='text-white text-[18px] font-semibold flex-wrap'>{userText?userText:aiText?aiText: null}</h1>
      </div>
    );
